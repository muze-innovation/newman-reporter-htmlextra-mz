...
util = {
    ...
    /**
     * return grand parents array
     *
     * @param {PostmanItem|PostmanItemGroup} item The base item
     * @returns {Array<PostmanItem|PostmanItemGroup>} Array of parents
     * @private
     */
    getGrandParents (item) {
        if (_.isEmpty(item) || !_.isFunction(item.parent) || !_.isFunction(item.forEachParent)) { return; }
